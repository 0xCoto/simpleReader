...
averagePhase = np.average(sumArray,axis=1)
...
# Get the value of the S/N of the pulse
...
ax1.annotate('S/N = '+str(max_snr)[:4], xy=(8, 316), xycoords='axes points', size=18, ha='left', va='top', color='brown')
